...
# df_long <- summary %>%
#   pivot_longer(
#     cols = c(F1_CMC, F1_oncoKB, F1_COSMIC),
#     names_to = "Metric",
#     values_to = "Value"
#   )
# df_long$method <- factor(df_long$method)
# df_long$Metric <- factor(df_long$Metric,
#                          levels = c("F1_CMC", "F1_oncoKB", "F1_COSMIC"),
#                          labels = c("CMC", "OncoKB", "COSMIC"))
# F1_plot <- ggplot(na.omit(df_long), aes(x = method, y = Value, fill = method)) +
#   # geom_violin(alpha = 0.6, width = 0.4) +
#   geom_boxplot(outlier.shape = NA, alpha = 1, color = "black", size = 0.75, width = 0.6) +
#   stat_boxplot(geom = "errorbar", width = 0.3, size = 0.75, color = "black") +
#   scale_fill_manual(values = fill_col) +
...
#   theme_bw() +
#   labs(title = "F1-Score Summary", x = "Method", y = "F1-Score") +
#   theme(
#     panel.grid = element_blank(),
#     # axis.line = element_line(color = "black"), #, linewidth = 0.5
#     # axis.ticks = element_line(color = "black"), # , linewidth = 0.5)
...
# df_long <- summary %>%
#   pivot_longer(
#     cols = c(prop_inter_core, prop_oncoKB_inter_core, prop_COSMIC_inter_core),
#     names_to = "Metric",
#     values_to = "Value"
#   )
# df_long$method <- factor(df_long$method)
# df_long$Metric <- factor(df_long$Metric,
#                          levels = c("prop_inter_core", "prop_oncoKB_inter_core", "prop_COSMIC_inter_core"),
#                          labels = c("CMC", "OncoKB", "COSMIC"))
# prop_core_plot <- ggplot(na.omit(df_long), aes(x = method, y = Value, fill = method)) +
#   # geom_violin(alpha = 0.6, width = 0.4) +
#   geom_boxplot(outlier.shape = NA, alpha = 1, color = "black", size = 0.75, width = 0.6) +
#   stat_boxplot(geom = "errorbar", width = 0.3, size = 0.75, color = "black") +
#   scale_fill_manual(values = fill_col) +
...
#   facet_wrap(~ Metric, scales = "free_y") +
#   theme_bw() +
#   labs(title = "% Cancer-related in core elements Summary", x = "Method", y = "% Cancer-related in core elements") +
#   theme(
#     panel.grid = element_blank(),
#     # axis.line = element_line(color = "black"), #, linewidth = 0.5
#     # axis.ticks = element_line(color = "black"), # , linewidth = 0.5)
...
#   )
#
# # prop_inter_cancer related
# df_long <- summary %>%
#   pivot_longer(
#     cols = c(prop_inter_CMC, prop_inter_oncoKB, prop_inter_COSMIC),
#     names_to = "Metric",
#     values_to = "Value"
#   )
# df_long$method <- factor(df_long$method)
# df_long$Metric <- factor(df_long$Metric,
#                          levels = c("prop_inter_CMC", "prop_inter_oncoKB", "prop_inter_COSMIC"),
#                          labels = c("CMC", "OncoKB", "COSMIC"))
# prop_related_plot <- ggplot(na.omit(df_long), aes(x = method, y = Value, fill = method)) +
#   # geom_violin(alpha = 0.6, width = 0.4) +
#   geom_boxplot(outlier.shape = NA, alpha = 1, color = "black", size = 0.75, width = 0.6) +
#   stat_boxplot(geom = "errorbar", width = 0.3, size = 0.75, color = "black") +
#   scale_fill_manual(values = fill_col) +
...
#   facet_wrap(~ Metric, scales = "free_y") +
#   theme_bw() +
#   labs(title = "% Cancer-related Summary", x = "Method", y = "% Cancer-related that have been detected") +
#   theme(
#     panel.grid = element_blank(),
#     # axis.line = element_line(color = "black"), #, linewidth = 0.5
#     # axis.ticks = element_line(color = "black"), # , linewidth = 0.5)
...
#   )
#
# p <- (g_median_plot | F1_plot) / (prop_core_plot | prop_related_plot)
# ggsave(paste0(result_dir, "summary.pdf"), p, width = 10, height = 10)
